...
//发送文件          
                box.file_number ++;
                box.file_account[box.talk_number] = atoi(row[0]);
                strcpy(box.file_date[box.talk_number],row[3]);
                strcpy(box.file[box.talk_number],row[1]);
            }
